...
var sidebar = L.control.sidebar('sidebar').addTo(this_map);
...
var lagen = {
    ...
    /*seinen: L.WMS.overlay('https://bam.projectxplor.nl/geoserver/BAM/wms?', {
        layers: 'BAM:seinen240217',
        format: 'image/png',
        transparent: true,
        maxZoom: 24,
        zIndex: 11,
...
$(".leaflet-tooltip-pane").hide();

this_map.on('zoomend', function (e) {

	if (this_map.getZoom() > 12)
	{
	  if( this_map.getZoom() == 13 )
	  {
		$(".leaflet-tooltip-pane").show();
